  ...
  return (
    ...
    >
      ...
      <g id="Italy_svg_surface1">
        ...
        />
        <g clipPath="url(#Italy_svg_clip1)" clipRule="nonzero">
          <g clipPath="url(#Italy_svg_clip2)" clipRule="evenodd">
            <path
              style={{
                stroke: "none",
                fillRule: "evenodd",
        ...
        <g clipPath="url(#Italy_svg_clip3)" clipRule="nonzero">
          <g clipPath="url(#Italy_svg_clip4)" clipRule="evenodd">
            <path
              style={{
                stroke: "none",
                fillRule: "evenodd",
